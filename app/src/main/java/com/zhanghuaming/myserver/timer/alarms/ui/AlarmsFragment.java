...
import com.zhanghuaming.myserver.timer.alarms.data.AlarmCursor;
import com.zhanghuaming.myserver.timer.alarms.data.AlarmsListCursorLoader;
import com.zhanghuaming.myserver.timer.alarms.data.AsyncAlarmsTableUpdateHandler;
...
import static com.zhanghuaming.myserver.timer.util.FragmentTagUtils.makeTag;
...
//        long scrollToStableId = getActivity().getIntent().getLongExtra(EXTRA_SCROLL_TO_ALARM_ID, -a);
//        if (scrollToStableId != -a) {
