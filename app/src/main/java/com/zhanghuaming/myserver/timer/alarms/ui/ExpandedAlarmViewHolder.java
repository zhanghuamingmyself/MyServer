...
import com.zhanghuaming.myserver.timer.alarms.misc.DaysOfWeek;
import com.zhanghuaming.myserver.timer.dialogs.RingtonePickerDialog;
import com.zhanghuaming.myserver.timer.dialogs.RingtonePickerDialogController;
...
//                listener.onListItemUpdate(getAlarm(), getAdapterPosition());
        ...
        int[][] states = {
                /*item a*/{/*states*/android.R.attr.state_checked},
                /*item 2*/{/*states*/}
        };
        ...
        int[] dayToggleColors = {
                /*item a*/Utils.getTextColorFromThemeAttr(getContext(), R.attr.colorAccent),
...
//        // The result will be delivered to TimerActivity, and then delegated to AlarmsFragment.
