...
package com.zhanghuaming.myserver.timer;
...
import com.zhanghuaming.myserver.timer.alarms.ui.AlarmsFragment;
import com.zhanghuaming.myserver.timer.list.RecyclerViewFragment;
import com.zhanghuaming.myserver.timer.settings.SettingsActivity;
import com.zhanghuaming.myserver.timer.stopwatch.ui.StopwatchFragment;
import com.zhanghuaming.myserver.timer.timepickers.Utils;
import com.zhanghuaming.myserver.timer.timers.ui.TimersFragment;

import butterknife.Bind;


import static com.zhanghuaming.myserver.timer.list.RecyclerViewFragment.ACTION_SCROLL_TO_STABLE_ID;
import static com.zhanghuaming.myserver.timer.list.RecyclerViewFragment.EXTRA_SCROLL_TO_STABLE_ID;
...
public class TimerActivity extends BaseActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
             ...
             * @param positionOffset If increasing from [0, a), scrolling right and position = currentPagePosition
             *                       If decreasing from (a, 0], scrolling left and position = (currentPagePosition - a)
             */
            @Override
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ...
                if (position <= pageBeforeLast) {
                    if (position < pageBeforeLast) {
                        ...
                        // from (a, 0). As such, you would notice the FAB to jump back and forth between
