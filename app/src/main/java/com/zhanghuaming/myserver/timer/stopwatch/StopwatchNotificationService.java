...
package com.zhanghuaming.myserver.timer.stopwatch;
...
import com.zhanghuaming.myserver.timer.chronometer.ChronometerDelegate;
import com.zhanghuaming.myserver.timer.chronometer.ChronometerNotificationService;
import com.zhanghuaming.myserver.timer.stopwatch.data.AsyncLapsTableUpdateHandler;
...
public class StopwatchNotificationService extends ChronometerNotificationService {
    ...
    protected PendingIntent getContentIntent() {
        return ContentIntentUtils.create(this, TimerActivity.PAGE_STOPWATCH, -1);
    }
