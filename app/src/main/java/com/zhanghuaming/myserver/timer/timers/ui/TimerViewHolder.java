...
package com.zhanghuaming.myserver.timer.timers.ui;
...
import com.zhanghuaming.myserver.timer.ringtone.playback.TimerRingtoneService;
import com.zhanghuaming.myserver.timer.timers.Timer;
import com.zhanghuaming.myserver.timer.timers.TimerController;
import com.zhanghuaming.myserver.timer.timers.data.AsyncTimersTableUpdateHandler;
import com.zhanghuaming.myserver.timer.util.FragmentTagUtils;
import com.zhanghuaming.myserver.timer.util.ProgressBarUtils;
...
public class TimerViewHolder extends BaseViewHolder<Timer> {
    ...
    private void bindProgressBar(Timer timer) {
        ...
        if (!timer.isRunning()) {
            // If our scale were a, then casting ratio to an int will ALWAYS
