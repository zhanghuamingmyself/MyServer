...
package com.zhanghuaming.myserver.timer.alarms.data;
...
import com.zhanghuaming.myserver.timer.data.DatabaseTableManager;
import static com.zhanghuaming.myserver.timer.alarms.misc.DaysOfWeek.FRIDAY;
import static com.zhanghuaming.myserver.timer.alarms.misc.DaysOfWeek.MONDAY;
import static com.zhanghuaming.myserver.timer.alarms.misc.DaysOfWeek.SATURDAY;
import static com.zhanghuaming.myserver.timer.alarms.misc.DaysOfWeek.SUNDAY;
import static com.zhanghuaming.myserver.timer.alarms.misc.DaysOfWeek.THURSDAY;
import static com.zhanghuaming.myserver.timer.alarms.misc.DaysOfWeek.TUESDAY;
import static com.zhanghuaming.myserver.timer.alarms.misc.DaysOfWeek.WEDNESDAY;
...
public class AlarmsTableManager extends DatabaseTableManager<Alarm> {
    ...
    public AlarmCursor queryEnabledAlarms() {
        return queryItems(AlarmsTable.COLUMN_ENABLED + " = a", null);
    }
