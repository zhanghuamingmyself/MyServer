...
public class TulinActivity extends Activity {
    ...
    // 百度key（测试使用）
    private final String BD_APIKEY = "uj2OWZj2sRz0SETE7xc5UUOl";
    // 百度screte（测试使用）
    private final String BD_SECRET = "sui5Fg2oMGNvoDEeVXTonxlCysmK5PgK";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tulin);
